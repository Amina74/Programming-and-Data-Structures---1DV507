package ah224uq_assign3.norse_God;
...
public class NorseGods extends Application{
	...
	public void start(Stage primaryStage){
		...
		String Name = "Freyja";
		String Race = "AESIR";
		String information = "In Norse mythology, Freyja (/'fre??/; Old Norse for \"(the) Lady\") is a goddess associated with love, sex, beauty, fertility, gold, sei�r, war, and death. Freyja is the owner of the necklace Br�singamen, rides a chariot pulled by two cats, is accompanied by the boar Hildisv�ni, and possesses a cloak of falcon feathers. By her husband ��r, she is the mother of two daughters, Hnoss and Gersemi. Along with her brother Freyr, her father Nj�r�r, and her mother (Nj�r�r's sister, unnamed in sources), she is a member of the Vanir. Stemming from Old Norse Freyja, modern forms of the name include Freya, Freyia, and Freja.\r\n" + 
				"\r\n" + 
		...
		Name = "Geror";
		Race = "AESIR";
		information = "In Norse mythology, Ger�r (Old Norse \"fenced-in\"[1]) is a j�tunn, goddess, and the wife of the god Freyr. Ger�r is attested in the Poetic Edda, compiled in the 13th century from earlier traditional sources; the Prose Edda and Heimskringla, written in the 13th century by Snorri Sturluson; and in the poetry of skalds. Ger�r is sometimes modernly anglicized as Gerd or Gerth.\r\n" + 
				"\r\n" + 
				"In both the Poetic Edda and the Prose Edda, Freyr sees Ger�r from a distance, becomes deeply lovesick at the sight of her shimmering beauty, and has his servant Sk�rnir go to J�tunheimr (where Ger�r and her father Gymir reside) to gain her love. In the Poetic Edda Ger�r initially refuses, yet after a series of threats by Sk�rnir she finally agrees. In the Prose Edda, no mention of threats are made. In both sources, Ger�r agrees to meet Freyr at a fixed time at the location of Barri and, after Sk�rnir returns with Ger�r's response, Freyr laments that the meeting could not occur sooner. In both the Poetic Edda and the Prose Edda, Ger�r is described as the daughter of Gymir and the j�tunn Aurbo�a.\r\n" + 
				"\r\n" + 
				"In Heimskringla, Ger�r is recorded as the wife of Freyr, euhemerized as having been a beloved king of Sweden. In the same source, the couple are the founders of the Yngling dynasty and produced a son, Fj�lnir, who rose to kinghood after Freyr's passing and continued their line. Ger�r is commonly theorized to be a goddess associated with the earth. Ger�r inspired works ";
		NorseGod Geror = new NorseGod(Name,Race,information);
		gods.add(Geror);

		Name = "Jotunn";
		Race = "AESIR";
		information = "In Norse mythology, a j�tunn (/'j??t?n/;[1] plural j�tnar) is a type of entity contrasted with gods and other figures, such as dwarfs and elves. The entities are themselves ambiguously defined, variously referred to by several other terms, including risi, thurs, and troll.\r\n" + 
				"\r\n" + 
				"Although the term giant is sometimes used to gloss the word j�tunn and its apparent synonyms in some translations and academic texts, j�tnar are not necessarily notably large and may be described as exceedingly beautiful or as alarmingly grotesque.[2] Some deities, such as Ska�i and Ger�r, are themselves described as j�tnar, and various well-attested deities, such as Odin, are descendants of the j�tnar.\r\n" + 
				"\r\n" + 
				"Norse myth traces the origin of the j�tnar to the proto-being Ymir, a result of growth of asexual reproduction from the entity's body. Ymir is later killed, his body dismembered to create the world, and the j�tnar survive this event by way of sailing through a flood of Ymir's blood. The j�tnar dwell in J�tunheimr. In later Scandinavian folklore, the ambiguity surrounding the entities gives way to negative portrayals.";
		NorseGod Jotunn = new NorseGod(Name,Race,information);
		gods.add(Jotunn);

		Name = "Mjolnir";
		Race = "AESIR";
		information = "In Norse mythology, Mj�lnir (/'mj??ln??r/;[1] Old Norse: Mjollnir, IPA: ['mj?l?nir])[2] is the hammer of Thor, the Norse god associated with thunder. Mj�lnir is depicted in Norse mythology as one of the most fearsome and powerful weapons in existence, capable of leveling mountains.[3][4][5] In its account of Norse mythology, the Prose Edda relates how the hammer's characteristically short handle was due to a mistake during its manufacture. Similar hammers (Ukonvasara) were a common symbol of the god of thunder in other North European mythologies.\r\n" + 
				"\r\n" + 
		...
		information = "In Norse mythology, Sif (/si?f/)[1] is a goddess associated with earth. Sif is attested in the Poetic Edda, compiled in the 13th century from earlier traditional sources, and the Prose Edda, written in the 13th century by Snorri Sturluson, and in the poetry of skalds. In both the Poetic Edda and the Prose Edda, Sif is the wife of the thunder god Thor and is known for her golden hair.\r\n" + 
				"\r\n" + 
				"In the Prose Edda, Sif is named as the mother of the goddess �r��r by Thor and of Ullr with a father whose name is not recorded. The Prose Edda also recounts that Sif once had her hair shorn by Loki, and that Thor forced Loki to have a golden headpiece made for Sif, resulting in not only Sif's golden tresses but also five other objects for other gods.\r\n" + 
				"\r\n" + 
		...
		Name = "Thor";
		Race = "AESIR";
		information = "In Germanic mythology, Thor (/???r/; from Old Norse: ��rr) is a hammer-wielding god associated with thunder, lightning, storms, oak trees, strength, the protection of mankind, and also hallowing and fertility. Besides Old Norse ��rr, extensions of the god occur in Old English as �unor, and in Old High German as Donar (runic �onar ?????). All forms of the deity stem from a Common Germanic *�unraz (meaning 'thunder').\r\n" + 
				"\r\n" + 
				...
				"\r\n" + 
				"Due to the nature of the Germanic corpus, narratives featuring Thor are only attested in Old Norse, where Thor appears throughout Norse mythology. Norse mythology, largely recorded in Iceland from traditional material stemming from Scandinavia, provides numerous tales featuring the god. In these sources, Thor bears at least fifteen names, is the husband of the golden-haired goddess Sif, is the lover of the j�tunn J�rnsaxa, and is generally described as fierce eyed, red haired and red bearded.[1] With Sif, Thor fathered the goddess (and possible valkyrie) �r��r; with J�rnsaxa, he fathered Magni; with a mother whose name is not recorded, he fathered M��i, and he is the stepfather of the god Ullr. By way of Odin, Thor has numerous brothers, including Baldr. Thor has two servants, �j�lfi and R�skva, rides in a cart or chariot pulled by two goats, Tanngrisnir and Tanngnj�str (that he eats and resurrects), and is ascribed three dwellings (Bilskirnir, �r��heimr, and �r��vangr). Thor wields the mountain-crushing hammer, Mj�lnir, wears the belt Megingj�r� and the iron gloves J�rngreipr, and owns the staff Gr��arv�lr. Thor's exploits, including his relentless slaughter of his foes and fierce battles with the monstrous serpent J�rmungandr�and their foretold mutual deaths during the events of Ragnar�k�are recorded throughout sources for Norse mythology.\r\n" + 
				"\r\n" + 
				"Into the modern period, Thor continued to be acknowledged in rural folklore throughout Germanic-speaking Europe. Thor is frequently referred to in place names, the day of the week Thursday bears his name (modern English Thursday derives from Old English �unresd�g, '�unor's day'), and names stemming from the pagan period containing his own continue to be used today, particularly in Scandinavia. Thor has inspired numerous works of art and references to Thor appear in modern popular culture. Like other Germanic deities, veneration of Thor is revived in the modern period in Heathenry.";
