...
public class Yahtzee extends Application {
	...
	public static ImageView putImage(int n, double x, double y) {
		...
		switch (n) {
		case 1:
			Image diec1 = new Image("/Users/mummy/Desktop/4key/src/ah224uq_assign2/Die/1.png");
			im.setImage(diec1);
			break;
		case 2:
			Image diec2 = new Image("/Users/mummy/Desktop/4key/src/ah224uq_assign2/Die/2.png");
			im.setImage(diec2);
			break;
		case 3:
			Image diec3 = new Image("/Users/mummy/Desktop/4key/src/ah224uq_assign2/Die/3.png");
			im.setImage(diec3);
			break;
		case 4:
			Image diec4 = new Image("/Users/mummy/Desktop/4key/src/ah224uq_assign2/Die/4.png");
			im.setImage(diec4);
			break;
		case 5:
			Image diec5 = new Image("/Users/mummy/Desktop/4key/src/ah224uq_assign2/Die/5.png");
			im.setImage(diec5);
			break;
		default:
			...
			if (rolls >= 0) {
				...
				for (int k = 0; k < 5; k++) {
					...
					if (!boxes.get(k).isSelected()) {
						int n = diec();
						images.get(k).setImage(new Image("/Users/mummy/Desktop/4key/src/ah224uq_assign2"+ n + ".png"));
						dices.set(k, n - 1);
					}
